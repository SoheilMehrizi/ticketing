...
app_name = "ticketing"
urlpatterns = [
    path("create_ticket/", views.Create_ticket_view.as_view(),name = "create_ticket"),
    path("show_all_tickets/", views.show_all_tickets_TemplateView.as_view(), name="show_all_tickets"),
    path("ticket_detail/<int:ticket_id>/", views.ticket_detail_TemplateView.as_view(), name= "ticket_detail_view"),
